...
| `Recipient` | string | Yes | The `AI-Infer Router Process ID`: `QwaPu_yGGKtzfRQ9EDdkPulLrCGOIpbIqc40PvFq6YU`. |
...
ao.send({
    ...
    Recipient = "9I9F1IHS94oUABzKclMW8f2oj7_6_X9zGA_fnMZ_AzY", -- Our Router Process
    Action = "Transfer",
...
- **Target:** `QwaPu_yGGKtzfRQ9EDdkPulLrCGOIpbIqc40PvFq6YU` (AI-Infer Router Process ID)
- **Action:** `Infer`
...
- **Router Process ID:** `9I9F1IHS94oUABzKclMW8f2oj7_6_X9zGA_fnMZ_AzY`
