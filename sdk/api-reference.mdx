...
| `Recipient` | string | Yes | The `AI-Infer Router Process ID`: `ZIc9924GI_wMzPayOZAgVjaxasNq1rIQwdSZseGoh7M`. |
...
ao.send({
    ...
    Recipient = "ZIc9924GI_wMzPayOZAgVjaxasNq1rIQwdSZseGoh7M", -- Our Router Process
    Action = "Transfer",
...
- **Target:** `ZIc9924GI_wMzPayOZAgVjaxasNq1rIQwdSZseGoh7M` (AI-Infer Router Process ID)
- **Action:** `Infer`
